...
class DevicePaypalSubscriptionScreen extends StatefulWidget {
  const DevicePaypalSubscriptionScreen({super.key});

  @override
  DevicePaypalSubscriptionScreenState createState() =>
      DevicePaypalSubscriptionScreenState();
}

class DevicePaypalSubscriptionScreenState
    extends State<DevicePaypalSubscriptionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("PayPal Subscription"),
          leading: IconButton(
            onPressed: () {
